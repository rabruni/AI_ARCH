...
AGENTS = {
    "Claude": ["claude", "--dangerously-skip-permissions", "-p", "Follow Startup & Activation Protocol in AGENTS.md"],
    "Gemini": ["gemini", "--yolo", "-p", "Follow Startup & Activation Protocol in AGENTS.md"],
    "Codex": ["copilot", "--allow-all-tools", "-p", "Follow Startup & Activation Protocol in AGENTS.md"]
}
