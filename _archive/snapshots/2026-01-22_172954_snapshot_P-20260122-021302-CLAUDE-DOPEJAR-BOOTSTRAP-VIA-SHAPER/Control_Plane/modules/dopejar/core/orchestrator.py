...
from dopejar.config.settings import MODEL, MAX_TOKENS, PROMPTS_DIR, MEMORY_DIR
from dopejar.core.memory import Memory  # v1 - kept for conversation saving
from dopejar.core.memory_v2 import CompressedMemory, PATTERN_CODES, COACHING_CODES
from dopejar.core.proactive import ProactiveEngine
from dopejar.core.ai_reflection import AIReflection
from dopejar.core.integrity import get_boot_context_for_ai
from dopejar.core.perception_agent import PerceptionAgent
